...
class ClassControllerContractTest {
    ...
    void createHomeroomClassShouldReturn201() throws Exception {
        ...
        com.visor.school.academicservice.model.Class mockClass = new com.visor.school.academicservice.model.Class("Grade 3 Homeroom", ClassType.HOMEROOM, null, 3, homeroomTeacherId, null, "2024-2025", Term.FIRST_TERM, null, null, LocalDate.of(2024, 9, 1), null, ClassStatus.SCHEDULED);
