...
public class ClassController {
    ...
    public ResponseEntity<ApiResponse<ClassResponse>> createHomeroomClass(@Valid @RequestBody CreateHomeroomClassRequest request) {
        ...
        com.visor.school.academicservice.model.Class classEntity = classService.createHomeroomClass(
                request.className(),
                request.gradeLevel(),
    ...
    public ResponseEntity<ApiResponse<ClassResponse>> createSubjectClass(@Valid @RequestBody CreateSubjectClassRequest request) {
        ...
        com.visor.school.academicservice.model.Class classEntity = classService.createSubjectClass(
                request.className(),
                request.subject(),
                request.gradeLevel(),
                request.academicYear(),
    ...
    public ResponseEntity<ApiResponse<ClassResponse>> assignClassTeacher(
        ...
        com.visor.school.academicservice.model.Class classEntity = classService.assignClassTeacher(
                classId,
                request.teacherId(),
                request.assignedBy()
        );
    ...
    public ResponseEntity<ApiResponse<ClassResponse>> getClass(@PathVariable UUID id) {
        com.visor.school.academicservice.model.Class classEntity = classService.getClassById(id);
        if (classEntity == null) {
    ...
    public ResponseEntity<ApiResponse<List<ClassResponse>>> getClassesByGradeLevel(
        ...
        List<com.visor.school.academicservice.model.Class> classes = classService.getClassesByGradeLevel(gradeLevel);
    ...
    public ResponseEntity<ApiResponse<ClassResponse>> updateClassStatus(
        ...
        com.visor.school.academicservice.model.Class classEntity = classService.updateClassStatus(id, request.status());
...
record ClassResponse(
    ...
    public static ClassResponse from(com.visor.school.academicservice.model.Class classEntity) {
