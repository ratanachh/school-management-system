...
public class ClassService {
     ...
     */
    public com.visor.school.academic.model.Class createHomeroomClass(
            String className,
            int gradeLevel,
        ...
        List<com.visor.school.academic.model.Class> existingHomeroom = classRepository.findByAcademicYearAndTermAndTypeAndGrade(
                academicYear,
                term,
                ClassType.HOMEROOM,
                gradeLevel
        ...
        com.visor.school.academic.model.Class classEntity = new com.visor.school.academic.model.Class(
                className,
                ClassType.HOMEROOM,
                null,
                gradeLevel,
        ...
        com.visor.school.academic.model.Class saved = classRepository.save(classEntity);
     ...
     */
    public com.visor.school.academic.model.Class createSubjectClass(
            String className,
            String subject,
            int gradeLevel,
            String academicYear,
     ...
     */
    public com.visor.school.academic.model.Class assignClassTeacher(
            UUID classId,
            UUID teacherId,
            UUID assignedBy
    ) {
        ...
        com.visor.school.academic.model.Class classEntity = classRepository.findById(classId)
    ...
    public com.visor.school.academic.model.Class getClassById(UUID id) {
     ...
     */
    @Transactional(readOnly = true)
    public List<com.visor.school.academic.model.Class> getClassesByGradeLevel(int gradeLevel) {
        if (gradeLevel < 1 || gradeLevel > 12) {
            throw new IllegalArgumentException("Grade level must be between 1 and 12, got: " + gradeLevel);
        }
     ...
     */
    @Transactional(readOnly = true)
    public List<com.visor.school.academic.model.Class> getClassesByType(ClassType classType) {
     ...
     * Update class status
     */
    public com.visor.school.academic.model.Class updateClassStatus(UUID id, ClassStatus status) {
        com.visor.school.academic.model.Class classEntity = classRepository.findById(id)
