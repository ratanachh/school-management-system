...
('audit-service', 'default', 'master', 'spring.datasource.url', 'jdbc:postgresql://localhost:5432/audit_service'),
('audit-service', 'default', 'master', 'spring.datasource.username', '${DB_USERNAME:school_user}'),
('audit-service', 'default', 'master', 'spring.datasource.password', '${DB_PASSWORD:change_me}'),
...
('audit-service', 'default', 'master', 'spring.rabbitmq.username', '${RABBITMQ_USER:admin}'),
('audit-service', 'default', 'master', 'spring.rabbitmq.password', '${RABBITMQ_PASSWORD:change_me}'),
...
('audit-service', 'default', 'master', 'keycloak.credentials.secret', '${KEYCLOAK_CLIENT_SECRET:change_me}'),
...
('audit-service', 'default', 'master', 'management.metrics.tags.environment', '${ENVIRONMENT:development}'),
