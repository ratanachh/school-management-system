...
('user-service', 'default', 'master', 'keycloak.service-client-id', '${KEYCLOAK_SERVICE_CLIENT_ID}'),
('user-service', 'default', 'master', 'keycloak.service-client-secret', '${KEYCLOAK_SERVICE_CLIENT_SECRET}'),
