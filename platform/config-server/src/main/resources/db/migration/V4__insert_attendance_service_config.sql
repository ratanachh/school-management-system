...
('attendance-service', 'default', 'master', 'spring.datasource.url', 'jdbc:postgresql://localhost:5432/attendance_service'),
('attendance-service', 'default', 'master', 'spring.datasource.username', '${DB_USERNAME:school_user}'),
('attendance-service', 'default', 'master', 'spring.datasource.password', '${DB_PASSWORD:change_me}'),
...
('attendance-service', 'default', 'master', 'spring.rabbitmq.username', '${RABBITMQ_USER:admin}'),
('attendance-service', 'default', 'master', 'spring.rabbitmq.password', '${RABBITMQ_PASSWORD:change_me}'),
...
('attendance-service', 'default', 'master', 'keycloak.credentials.secret', '${KEYCLOAK_CLIENT_SECRET:change_me}'),
...
('attendance-service', 'default', 'master', 'management.metrics.tags.environment', '${ENVIRONMENT:development}'),
